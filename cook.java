...
public class cook extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse 
        ...
        out.println("<head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,"
        		+ " initial-scale=1.0'><title>Username/Email Form</title></head>");
        out.println("<body>");
        ...
        out.println("<input type='text' id='userInput' name='userInput' value='" 
        + usernameOrEmail + "'>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect("cook.html");
    }
}